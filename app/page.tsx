...
export default function Home() {
  ...
  // Create refs and inView states for each timeline item at the top level
  const timelineRefs = timelineItems.map(() => useInView({
    triggerOnce: false,
    threshold: 0.1,
  }));
          ...
          <div className="container mx-auto px-4 z-10">
            ...
            >
              ...
              <p className={`text-lg md:text-xl ${isDarkMode ? 'text-gray-300' : 'text-gray-700'} max-w-2xl mx-auto mb-10`}>
                Saya Ibnu Risqi Saputro, Simak lika-liku perjalanan saya di dunia coding, dari pusing debugging hingga akhirnya bisa login!
              </p>
          ...
          <div className="container mx-auto px-4 relative z-10">
            ...
            <div className="relative max-w-5xl mx-auto">
              ...
              <motion.div 
                ...
                style={{ 
                  height: useTransform(scrollYProgress, [0, 0.2, 0.6], ['0%', '50%', '100%']),
                  originY: 0,
              ...
              <div className="relative">
                {timelineItems.map((item, index) => {
                  const [ref, inView] = timelineRefs[index]; // Use the pre-defined refs and inView states
